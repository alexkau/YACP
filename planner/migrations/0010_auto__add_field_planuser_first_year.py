...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlanUser.first_year'
        db.add_column(u'planner_planuser', 'first_year',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlanUser.first_year'
        db.delete_column(u'planner_planuser', 'first_year')
