...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlanCourse.credits'
        db.add_column(u'planner_plancourse', 'credits',
                      self.gf('django.db.models.fields.IntegerField')(default=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlanCourse.credits'
        db.delete_column(u'planner_plancourse', 'credits')
    ...
    models = {
        ...
        u'planner.plancourse': {
            ...
            'credits': ('django.db.models.fields.IntegerField', [], {'default': '4'}),
        ...
        u'planner.planuser': {
            ...
            'has_uploaded_capp': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
