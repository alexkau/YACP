...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlanCourse.spring_difficulty'
        db.add_column(u'planner_plancourse', 'spring_difficulty',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=4, decimal_places=2),
                      keep_default=False)

        # Adding field 'PlanCourse.fall_difficulty'
        db.add_column(u'planner_plancourse', 'fall_difficulty',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=4, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlanCourse.spring_difficulty'
        db.delete_column(u'planner_plancourse', 'spring_difficulty')

        # Deleting field 'PlanCourse.fall_difficulty'
        db.delete_column(u'planner_plancourse', 'fall_difficulty')
    ...
    models = {
        ...
        u'planner.plancourse': {
            ...
            'fall_difficulty': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '4', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'number': ('django.db.models.fields.IntegerField', [], {}),
            'semester': ('django.db.models.fields.IntegerField', [], {}),
            'spring_difficulty': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '4', 'decimal_places': '2'}),
