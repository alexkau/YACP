...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PlanCourse'
        db.create_table(u'planner_plancourse', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('course', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['courses.Course'], unique=True)),
        ))
        db.send_create_signal(u'planner', ['PlanCourse'])

        # Adding field 'PlanUser.user'
        db.add_column(u'planner_planuser', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['auth.User'], unique=True),
                      keep_default=False)

        # Adding field 'PlanUser.selections'
        db.add_column(u'planner_planuser', 'selections',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['scheduler.SavedSelection'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PlanCourse'
        db.delete_table(u'planner_plancourse')

        # Deleting field 'PlanUser.user'
        db.delete_column(u'planner_planuser', 'user_id')

        # Deleting field 'PlanUser.selections'
        db.delete_column(u'planner_planuser', 'selections_id')
    ...
    models = {
        ...
        u'planner.planuser': {
            ...
            'courses_taken': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['planner.PlanCourse']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'selections': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['scheduler.SavedSelection']", 'unique': 'True', 'null': 'True'}),
