...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlanCourse.movable'
        db.add_column(u'planner_plancourse', 'movable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'PlanUser.has_uploaded_capp'
        db.add_column(u'planner_planuser', 'has_uploaded_capp',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlanCourse.movable'
        db.delete_column(u'planner_plancourse', 'movable')

        # Deleting field 'PlanUser.has_uploaded_capp'
        db.delete_column(u'planner_planuser', 'has_uploaded_capp')
