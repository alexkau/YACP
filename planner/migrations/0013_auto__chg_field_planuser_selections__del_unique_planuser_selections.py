...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'PlanUser', fields ['selections']
        db.delete_unique(u'planner_planuser', ['selections_id'])


        # Changing field 'PlanUser.selections'
        db.alter_column(u'planner_planuser', 'selections_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scheduler.SavedSelection'], null=True))

    def backwards(self, orm):

        # Changing field 'PlanUser.selections'
        db.alter_column(u'planner_planuser', 'selections_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['scheduler.SavedSelection'], unique=True, null=True))
        # Adding unique constraint on 'PlanUser', fields ['selections']
        db.create_unique(u'planner_planuser', ['selections_id'])
