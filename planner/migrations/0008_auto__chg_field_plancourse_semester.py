...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'PlanCourse.semester' to match new field type.
        db.rename_column(u'planner_plancourse', 'semester_id', 'semester')
        # Changing field 'PlanCourse.semester'
        db.alter_column(u'planner_plancourse', 'semester', self.gf('django.db.models.fields.IntegerField')())
        # Removing index on 'PlanCourse', fields ['semester']
        db.delete_index(u'planner_plancourse', ['semester_id'])


    def backwards(self, orm):
        # Adding index on 'PlanCourse', fields ['semester']
        db.create_index(u'planner_plancourse', ['semester_id'])


        # Renaming column for 'PlanCourse.semester' to match new field type.
        db.rename_column(u'planner_plancourse', 'semester', 'semester_id')
        # Changing field 'PlanCourse.semester'
        db.alter_column(u'planner_plancourse', 'semester_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['courses.Semester']))
