...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlanCourse.spring_difficulty'
        db.alter_column(u'planner_plancourse', 'spring_difficulty', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=2, decimal_places=1))

        # Changing field 'PlanCourse.fall_difficulty'
        db.alter_column(u'planner_plancourse', 'fall_difficulty', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=2, decimal_places=1))

    def backwards(self, orm):

        # Changing field 'PlanCourse.spring_difficulty'
        db.alter_column(u'planner_plancourse', 'spring_difficulty', self.gf('django.db.models.fields.DecimalField')(max_digits=2, decimal_places=1))

        # Changing field 'PlanCourse.fall_difficulty'
        db.alter_column(u'planner_plancourse', 'fall_difficulty', self.gf('django.db.models.fields.DecimalField')(max_digits=2, decimal_places=1))
    ...
    models = {
        ...
        u'planner.plancourse': {
            ...
            'fall_difficulty': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '2', 'decimal_places': '1'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'number': ('django.db.models.fields.IntegerField', [], {}),
            'semester': ('django.db.models.fields.IntegerField', [], {}),
            'spring_difficulty': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '2', 'decimal_places': '1'}),
        ...
        u'planner.planuser': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'selections': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['scheduler.SavedSelection']", 'null': 'True', 'blank': 'True'}),
        ...
        u'scheduler.savedselection': {
            ...
            'internal_serialized': ('django.db.models.fields.TextField', [], {'db_index': 'True'})
        }
    }
