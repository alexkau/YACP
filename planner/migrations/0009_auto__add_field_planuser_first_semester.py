...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlanUser.first_semester'
        db.add_column(u'planner_planuser', 'first_semester',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlanUser.first_semester'
        db.delete_column(u'planner_planuser', 'first_semester')
