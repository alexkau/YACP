...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'PlanCourse', fields ['course']
        db.delete_unique(u'planner_plancourse', ['course_id'])


        # Changing field 'PlanCourse.course'
        db.alter_column(u'planner_plancourse', 'course_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['courses.Course']))

    def backwards(self, orm):

        # Changing field 'PlanCourse.course'
        db.alter_column(u'planner_plancourse', 'course_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['courses.Course'], unique=True))
        # Adding unique constraint on 'PlanCourse', fields ['course']
        db.create_unique(u'planner_plancourse', ['course_id'])
