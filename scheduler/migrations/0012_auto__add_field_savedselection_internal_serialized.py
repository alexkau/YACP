...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SavedSelection.internal_serialized'
        db.add_column(u'scheduler_savedselection', 'internal_serialized',
                      self.gf('django.db.models.fields.TextField')(default='', db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SavedSelection.internal_serialized'
        db.delete_column(u'scheduler_savedselection', 'internal_serialized')
